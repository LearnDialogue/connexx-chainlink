...
export const ProfileModal: React.FC<ProfileModalProps> = ({
  ...
  const showProfileInfo =
    !featureFlags.privateProfilesEnabled ||
      ...
      <div style={{ width: 300 }}>
        ...
        {showProfileInfo ? (
          <div className="profile-modal-content">
            <span className="profile-modal-descriptor-left">
              {userData.getUser.experience}
            </span>
            <span className="profile-modal-descriptor-right">
              {userData.getUser.eventsHosted.length + " Rides Joined"}
            </span>
          </div>
        ) : (
          <div className="profile-modal-content">
        ...
        <div className="friend-button-container">
          {featureFlags.friendsFeatureEnabled && (
            <FriendButton
              username={user}
